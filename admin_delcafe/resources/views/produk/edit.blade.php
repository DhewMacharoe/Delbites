                ...
                <div class="card-body">
                    <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_menu') is-invalid @enderror" id="nama_menu" name="nama_menu" value="{{ old('nama_menu', $produk->nama_menu) }}" required>
                            @error('nama_menu')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="stok_terjual" value="{{ $produk->stok_terjual }}" disabled>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if($produk->gambar)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/menu/' . $produk->gambar) }}" alt="{{ $produk->nama_menu }}" class="img-thumbnail" width="150">
                                </div>
                            @endif
                            <input type="file" class="form-control @error('gambar') is-invalid @enderror" id="gambar" name="gambar">
                            <small class="text-muted">Format: JPG, JPEG, PNG. Maksimal 2MB. Biarkan kosong jika tidak ingin mengubah gambar.</small>
                            @error('gambar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
