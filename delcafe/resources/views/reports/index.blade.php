        ...
        <div class="col-md-6 d-flex justify-content-md-end align-items-center">
            <div class="dropdown me-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                    <li>
                        <a class="dropdown-item" href="{{ route('reports.export.pdf', ['start_date' => $startDate->format('Y-m-d'), 'end_date' => $endDate->format('Y-m-d')]) }}">
                            <i class="fas fa-file-pdf me-1"></i> Ekspor PDF
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ route('reports.export.excel', ['start_date' => $startDate->format('Y-m-d'), 'end_date' => $endDate->format('Y-m-d')]) }}">
            ...
            <form action="{{ route('reports.index') }}" method="GET" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control date-range-picker" id="date_range" placeholder="Pilih rentang tanggal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('reports.receipt', ['pesanan' => $order->id]) }}" class="btn btn-sm btn-primary" target="_blank">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="orderDetailModalLabel{{ $order->id }}">Detail Pesanan #ORD-{{ str_pad($order->id, 3, '0', STR_PAD_LEFT) }}</h5>
                                ...
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $order->metode_pembayaran == 'tunai' ? 'Tunai' : ($order->metode_pembayaran == 'qris' ? 'QRIS' : 'Transfer Bank') }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                @forelse($order->detailPemesanans as $item)
                                                    <tr>
            ...
            <div class="modal-footer">
                <a href="{{ route('reports.receipt', ['pesanan' => $order->id]) }}" class="btn btn-primary" target="_blank">
