...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> fetchMenu() async {
    ...
    if (response.statusCode == 200) {
      ...
      List<Map<String, String>> filteredItems = data
          .where((item) => int.parse(item["stok"].toString()) > 0)
          .map((item) => {
      ...
      Map<String, List<Map<String, String>>> groupedByCategory = {};
      ...
      for (var category in groupedByCategory.keys) {
        topItems.addAll(groupedByCategory[category]!.take(3));
      }
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Color(0xFF4C53A5), Color(0xFF303A6A)],
        ),
      ),
      child: SafeArea(
        child: Stack(
    ...
    return Padding(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color(0xFFE4B91E),
          shape:
